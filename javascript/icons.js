...
linkedInIcon[0].addEventListener('click', e => window.open('https://www.linkedin.com/in/mdaisy/', '_blank'));

// Travis
githubIcon[1].addEventListener('click', e => window.open('https://github.com/tlaudahl', '_blank'));
linkedInIcon[1].addEventListener('click', e => window.open('https://www.linkedin.com/in/travis-laudahl', '_blank'));
